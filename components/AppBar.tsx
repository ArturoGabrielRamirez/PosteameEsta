...
export default function AppBar() {
    ...
    return (
        <header className={`lg:min-w-[400px] flex bg-gradient-to-br xl:bg-gradient-to-bl 
        ${currentTheme === 'light' 
        ? 'light-gradient' 
        : 'dark-gradient'} pl-4 py-4 pr-4 xl:py-8 xl:pl-8 `}>
            <div className="relative size-full min-sm:justify-center xl:flex xl:flex-col shadow-md shadow-[rgba(0,0,0,0.8)]">
                <BGTexture />
                <NailGroup />
                <div className="flex flex-col sm:flex-row items-center justify-center sm:justify-around xl:flex-col grow gap-2 xl:gap-56">
                    <CatLogoWithBG />
